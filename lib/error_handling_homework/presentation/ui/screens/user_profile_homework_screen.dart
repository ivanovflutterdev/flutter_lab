...
import 'package:flutter_lab/error_handling_homework/presentation/cubit/user_profile_state.dart';
    ...
    return Scaffold(
      ...
      body: BlocBuilder<UserProfileCubit, UserProfileState>(
        builder: (context, state) {
          return switch (state) {
            UserProfileError() => _ErrorProfileWidget(message: state.message),
...
class _ErrorProfileWidget extends StatelessWidget {
  const _ErrorProfileWidget({required this.message});
