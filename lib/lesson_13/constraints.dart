...
/// Відповідь: зелений контейнер виходить за межі SizedBox через OverflowBox,
/// але порядок Column йде зверху вниз.
/// Спочатку малюється червоний, зелений, тому зелений накладається на червоний.
/// Після йде синій контейнер, і він перекриває частину зеленого,
/// бо знаходиться нижче в списку children і малюється пізніше.
